<section id="new-cars" class="new-cars">
			<div class="container">
				<div class="section-header">
					<p>Second <span>Step</span> (Section 5)</p>
					<h2>Debit (BDT)</h2>
				</div><!--/.section-header-->
				<div class="new-cars-content">
                    ...
                    <h5 class="text-left">Debit: Land Purposes (BDT):</h5>
                    ...
                    <br><br>
<!-------------------------------------------------------------------------------------------------------->
                    <h5 class="text-left">Debit: Land Maintenance/Management(BDT)</h5>
                    <table class="table-fill">
                        <thead>
                        <tr>
                        <th class="text-center">Serial</th>
...
<!-------------------------------------------------------------------------------------------------------->
                    ...
                    <h5 class="text-left">Debit: Survay & Documents/Stationary(BDT)</h5>
                    <table class="table-fill">
                        <thead>
                        <tr>
                        <th class="text-center">Serial</th>
...
<!-------------------------------------------------------------------------------------------------------->
                    <div class="text-center">
                        ...
                        <button style="border:2px solid Violet;" class="welcome-btn"><a href="debit2nd_pdf">Download PDF</a></button>
                    </div>
