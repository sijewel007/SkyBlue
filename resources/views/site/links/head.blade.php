<head>
        ...
        <!-- For favicon png -->
		<link rel="shortcut icon" type="image/icon" href="site/assets/logo/favicon.png"/>
       
        <!--font-awesome.min.css-->
        <link rel="stylesheet" href="site/assets/css/font-awesome.min.css">

        <!--linear icon css-->
		<link rel="stylesheet" href="site/assets/css/linearicons.css">
		...
		<!-- bootsnav -->
		<link rel="stylesheet" href="site/assets/css/bootsnav.css" >	
        
        <!--style.css-->
        <link rel="stylesheet" href="site/assets/css/style.css">
        <link rel="stylesheet" href="site/assets/css/table.css">
