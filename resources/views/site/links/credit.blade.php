<section id="new-cars" class="new-cars">
			<div class="container">
				<div class="section-header">
					<p>Initial <span>Stage</span> (Member Deposits)</p>
					<h2>Credit (BDT)</h2>
				</div><!--/.section-header-->
        
				<div class="new-cars-content">
                  <div class="text-right">Member's Deposit(BDT): {{ $total_15 }} </div>
                  <div class="text-right">Bank Interests(BDT): {{ $total_16 }} </div>
                  <div class="text-right">Total Credit(BDT): {{ $total_17 }} </div>
                    ...
                    <div class="section-header">
                      <p>Initial <span>Stage</span> (Bank Interest)</p>
                      <h2>Credit (BDT)</h2>
                    </div><!--/.section-header-->
                    <br>
                    ...
                    <div class="text-center">
                        ...
                        <button style="border:2px solid Violet;" class="welcome-btn"><a href="credit_pdf">Download PDF</a></button>
                    </div>
